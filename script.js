document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function showError(field, message) {
      ...
      var existingError = field.parentElement.querySelector('.field__error-message');
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      var successMessage = contactForm.querySelector('.form__success-message');
      if (successMessage) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Internal Solutions משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f6866d4f-c7dc-4c8e-a6b0-194d2547cddc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f6866d4f-c7dc-4c8e-a6b0-194d2547cddc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f6866d4f-c7dc-4c8e-a6b0-194d2547cddc';
